  ...
  return (
    <form>
      <Card key={worn.id} className="min-w-96 perfume-card">
        <CardHeader>
            <a href={`/perfumes/${perfume.id}/`} className="flex items-center justify-between space-x-4 rounded-md border p-4">
              <Avatar className="w-20 h-20 semi-bold">
                <AvatarImage className="object-cover" src={getImageUrl(perfume?.imageObjectKey, r2_api_address)} />
