...
public record UserStatsResponse(
	...
	IEnumerable<FavoriteParfumeurDto> FavoriteParfumeurs,
...
public record FavoritePerfumeDto(Guid Id, string House, string PerfumeName, decimal LatestRating, int WearCount);
