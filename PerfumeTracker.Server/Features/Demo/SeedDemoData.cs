...
public static class SeedDemoData {
	...
	private static async Task SeedDemoPerfumesAsync(PerfumeTrackerContext context, Guid demoUserId, List<Guid> demoImageGuids) {
		...
		Perfume azure = new() {
			...
			Rating = 8.5,
			Notes = "A sophisticated woody aromatic fragrance with citrus top notes",
			Ml = 100,
			MlLeft = 85,
		...
		Perfume tobacco = new() {
			...
			Rating = 9.0,
			Notes = "Rich oriental with tobacco, vanilla, and spices",
			Ml = 50,
			MlLeft = 45,
			ImageObjectKeyNew = GetDemoImageGuid(),
			Autumn = true,
		...
		Perfume cool = new() {
			...
			Rating = 7.5,
			Notes = "Fresh and clean with sea salt",
			Ml = 100,
			MlLeft = 60,
			ImageObjectKeyNew = GetDemoImageGuid(),
			Autumn = false,
		...
		Perfume nocturne = new() {
			...
			Rating = 8.8,
			Notes = "Warm and boozy with rum, tobacco, and vanilla",
			Ml = 100,
			MlLeft = 80,
			ImageObjectKeyNew = GetDemoImageGuid(),
			Autumn = true,
		...
		Perfume bergamot = new() {
			...
			Rating = 8.2,
			Notes = "Classic Italian citrus cologne",
			Ml = 100,
			MlLeft = 90,
			ImageObjectKeyNew = GetDemoImageGuid(),
			Autumn = false,
