...
namespace PerfumeTracker.Server.Migrations
{
    ...
    [Migration("20260623060611_LatestRating")]
    partial class LatestRating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.CachedCompletion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("CachedCompletion_pkey");

                    b.HasIndex("UserId", "CompletionType", "Prompt")
                        .IsUnique()
                        .HasDatabaseName("IX_CachedCompletion_UserId_Type_Prompt");

                    b.ToTable("CachedCompletion", (string)null);
                });
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeRecommendation", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.CachedCompletion", "CachedCompletion")
                        .WithMany()
