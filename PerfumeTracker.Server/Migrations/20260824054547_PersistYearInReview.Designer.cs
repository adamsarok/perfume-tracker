...
namespace PerfumeTracker.Server.Migrations
{
    ...
    [Migration("20260824054547_PersistYearInReview")]
    partial class PersistYearInReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.ChatConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<Guid>>("DiscussedPerfumeIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.Property<DateTime?>("TitleGeneratedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasKey("Id")
                        .HasName("ChatConversation_pkey");

                    b.ToTable("ChatConversation", (string)null);
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int?>("ChatFinishReason")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.GlobalPerfume", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GlobalPerfume", (string)null);
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.GlobalPerfumeTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("GlobalPerfumeTag_pkey");

                    b.HasIndex("PerfumeId");

                    b.HasIndex("TagId");

                    b.ToTable("GlobalPerfumeTag", (string)null);
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.GlobalTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("GlobalTag_pkey");

                    b.HasIndex(new[] { "TagName" }, "Global_tag_key")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.ToTable("GlobalTag", (string)null);
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.Invite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.MarketplaceOffer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("MatchedPerfumeId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("SellerExternalId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("Id")
                        .HasName("MarketplaceOffer_pkey");

                    b.HasIndex("UserId", "Source", "SourceOfferId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.HasIndex("UserId", "Status", "MatchConfidence")
                        .HasDatabaseName("IX_MarketplaceOffer_UserId_Status_MatchConfidence");

                    b.ToTable("MarketplaceOffer", (string)null);
                });
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.Perfume", b =>
                {
                    ...
                    b.Property<decimal>("LatestRating")
                        .HasColumnType("numeric");
                    ...
                    b.Property<string>("Parfumeur")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("PerfumeIdentifiedStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PerfumeDocument_pkey");

                    b.ToTable("PerfumeDocument", (string)null);
                });
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeIdentityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeIdentityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PerfumeRating_pkey");

                    b.HasIndex("PerfumeId");

                    b.ToTable("PerfumeRating", (string)null);
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeRecommendation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PerfumeRecommendation_pkey");

                    b.HasIndex("PerfumeId");

                    b.ToTable("PerfumeRecommendation", (string)null);
                });
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.Tag", b =>
                {
                    ...
                    b.Property<int>("BackfillAttempts")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("LastBackfillAttempt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("NoteGroup")
                        .HasColumnType("text");
                    ...
                    b.HasIndex(new[] { "UserId", "TagName" }, "Tag_tag_key")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.UserProfile", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("PreferredRecommendationStrategies")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.UserStreak", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime>("LastProgressedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("Progress")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("StreakEndAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("StreakStartAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasKey("Id")
                        .HasName("UserStreak_pkey");

                    b.ToTable("UserStreak", (string)null);
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.YearInReviewSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("YearInReviewSnapshot_pkey");

                    b.HasIndex("UserId", "Year")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.ToTable("YearInReviewSnapshot", (string)null);
                });

            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.PerfumeIdentityRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.PerfumeIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.ChatMessage", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.ChatConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.GlobalPerfumeTag", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.GlobalPerfume", "GlobalPerfume")
                        .WithMany("GlobalPerfumeTags")
                        .HasForeignKey("PerfumeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("GlobalPerfumeTag_perfumeId_fkey");

                    b.HasOne("PerfumeTracker.Server.Models.GlobalTag", "GlobalTag")
                        .WithMany("GlobalPerfumeTags")
                        .HasForeignKey("TagId")
                    ...
                    b.Navigation("GlobalPerfume");

                    b.Navigation("GlobalTag");
                });

            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeDocument", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.Perfume", "Perfume")
                        .WithOne("PerfumeDocument")
                        .HasForeignKey("PerfumeTracker.Server.Models.PerfumeDocument", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.PerfumeRecommendation", b =>
                {
                    b.HasOne("PerfumeTracker.Server.Models.Perfume", "Perfume")
                        .WithMany("PerfumeRecommendations")
                        .HasForeignKey("PerfumeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.GlobalPerfume", b =>
                {
                    b.Navigation("GlobalPerfumeTags");
                });
            ...
            modelBuilder.Entity("PerfumeTracker.Server.Models.Perfume", b =>
                {
                    b.Navigation("PerfumeDocument");

                    b.Navigation("PerfumeEvents");

                    b.Navigation("PerfumeRatings");

                    b.Navigation("PerfumeRecommendations");
